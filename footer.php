            ...
            <div class="news-subscribe">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h3>Thanks to <strong>BongoKrisi Crop Auction</strong></h3>
                        </div>
                       <!-- 
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12" style="float: right;">
                            <div class="widget">
                                ...
                                <address>
                                    <p>United International University</p><br>
                                    <p>Phone: 0132114251</p>
                                    
                                    <p>E-mail: <a href="mailto:hasan.alvee15@gmail.com">hasan.alvee15@gmail.com</a></p>
                                </address>
                            </div>
                        </div>
                        <!-- END CONTACT WIDGET -->
                    ...
                    <div class="copyright">
                        <div class="text-center">
                            <p>© All Rights Reserved @ Team BongoKrisi</p>
                        </div>
                    </div>
