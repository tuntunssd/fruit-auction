...
<div class="container">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
       <select name="payment" id="payment" class="form-control">
					...
					<option value="DBBL online banking">DBBL online banking</option>
    ...
    <div class="form-group">        
      ...
      <div class="col-sm-4">          
        <input type="number" class="form-control" id="amount" placeholder="Enter total amount (TK)" name="amount">
      </div>
    </div>
    <div class="form-group">        
