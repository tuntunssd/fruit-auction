        ...
        <section class="spa-area spa-area-17">
           ...
           <div class="container">
            	...
            	<label>Bank information for deposit amount</label><br/>
          	  	<span>Bank: Bangladesh Bank</span><br/>
           	  	<span>Account name: Alvee</span><br/>
           	  	<span>Account No: 2551057778</span><br/><br/>
								...
								<div class="products grid-product mb30">
									<div class="product-grid-inner">
										...
										<div class="product-grid-caption text-center">
											...
											<h4>Base Price:<strong><?=$price?></strong> BDT</h4>
										<!--	<h5>Bid Price:<strong><?=$price?></strong> BDT</h5> -->
